              ...
              child: Padding(
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding:  EdgeInsets.symmetric(vertical: 25.0.h,horizontal: 30.0.w),
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,children:  [
                        ...
                        Container(
                          height:
                          35.h
                          ,clipBehavior: Clip.antiAliasWithSaveLayer,decoration:
                        BoxDecoration(color:AppColors.white, borderRadius: BorderRadius.circular(10.sp), ),
                          child: defaultFormField(
                            context: context,
                        ...
                        cubic.validationPassword==true?    const Text(
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            ...
                            buildItemImageContiener(isImageWithRadius: false,
                                ...
                                ImageAssets.google, heightImage:25.h ,
                                widthImage: 25.w ),

                            SizedBox(
                              width: 10.w,
                            ),
                            buildItemImageContiener(context,AppColors.white,
                              ImageAssets.vector, heightImage:25.h ,widthImage:
                              25.w,isImageWithRadius: false, ),
                    ...
                    SizedBox(
                            ...
                            buildItemImageContiener(context,AppColors.white,
                              ImageAssets.facebook ,heightImage:25.h ,widthImage:
                              25.w,isImageWithRadius: false, ),
                        ...
                        GestureDetector(child: twoTextWithUnderline(fristText:
                        AppStrings.dontHaveAn,secondText: AppStrings.signUp ),onTap: () {
