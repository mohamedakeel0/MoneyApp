...
appBarTheme: const AppBarTheme(
  ...
  systemOverlayStyle: SystemUiOverlayStyle(
      ...
      statusBarColor:AppColors.colorPrimaryDark,statusBarIconBrightness: Brightness.light,statusBarBrightness: Brightness.dark
  ),
  centerTitle: true,
...
buttonTheme: const ButtonThemeData(shape: StadiumBorder(),
  disabledColor: AppColors.grayDark,buttonColor: AppColors.colorPrimary,splashColor: AppColors.grayDark,
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(textStyle:const TextStyle(color: AppColors.black,fontSize: FontSize.s17),
  primary: AppColors.graySoft2,shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppSize.s12)),
    ),),
      //text theme
